...
document.getElementById("penezenka").innerHTML = "Zbývající peníze: " + penize + " Kč";
karty_new = karty;
srdce();
alert("Cílem hry je dosáhnout kombinací karet vyššího součtu než bot protihráč. Tento součet však nesmí překročit hodnotu 21. Pokud se tak stane, automaticky kolo prohráváte \nSvršek a spodek mají hodnotu 1, král má hodnotu 2, karty 7 - 10 mají stejné hodnoty a eso má hodnotu 11 \nPřeji příjemnou hru, a ne že prohraješ všechny peníze")
